...
Every few months, someone on your team reads a blog post about Slack's pricing and forwards the group a link to [Mattermost](/open-source/mattermost/) or [Rocket.Chat](/open-source/rocket-chat/). Few enthusiastic emojis. Someone spins up a test instance. Two weeks later, the conversation is back on Slack.
